...
const games = [
  ...
  { href: "/games/wordbuilder", emoji: "🧩", label: "Word Builder", sub: "Drag letters to spell", color: "#e74c3c", light: "#fdecea", ready: true },
  { href: "/games/evs", emoji: "🌿", label: "EVS", sub: "Identify plants & animals", color: "#27ae60", light: "#e8f8f0", ready: true },
  { href: "/games/phonics", emoji: "🔊", label: "Phonics", sub: "Letter sounds", color: "#f39c12", light: "#fff8e1", ready: true },
  { href: "#", emoji: "✏️", label: "Tracing", sub: "Coming soon", color: "#aaa", light: "#f5f5f5", ready: false },
  { href: "#", emoji: "🗣️", label: "Speak Word", sub: "Coming soon", color: "#aaa", light: "#f5f5f5", ready: false },
];
    ...
    <main className="min-h-screen flex flex-col items-center p-6 pb-12"
      ...
      <div className="w-full max-w-lg flex flex-col gap-6">
          ...
          {games.map((g) => (
            <a key={g.label} href={g.href}
              ...
              style={{
                ...
                pointerEvents: g.ready ? "auto" : "none"
              }}>
        ...
        <div className="rounded-3xl p-5 flex items-center gap-4"
          ...
          <div>
            <p className="font-bold" style={{ color: "#e07b39" }}>Keep learning!</p>
